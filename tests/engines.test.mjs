...
test("unknown source material stays intentionally unsupported", () => { const analysis = deterministicSourceAnalysis("A survey of medieval manuscript illumination techniques."); assert.equal(analysis.templateId, "unsupported"); assert.match(analysis.whyInteractive, /validated/i); });
