...
const transcriptPath = path.resolve("public/audio/p99-judge-voiceover.txt");
const outputPath = path.resolve("public/audio/p99-judge-voiceover.mp3");
const alignmentPath = path.resolve("public/audio/p99-judge-voiceover-alignment.json");
