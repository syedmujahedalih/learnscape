...
const transcriptPath = path.resolve("public/audio/p99-personal-voiceover.txt");
const outputPath = path.resolve("public/audio/p99-personal-voiceover.mp3");
const alignmentPath = path.resolve("public/audio/p99-personal-voiceover-alignment.json");
