...
const transcriptPath = path.resolve("public/audio/voiceover.txt");
const outputPath = path.resolve("public/audio/p99-voiceover.mp3");
const alignmentPath = path.resolve("public/audio/p99-voiceover-alignment.json");
