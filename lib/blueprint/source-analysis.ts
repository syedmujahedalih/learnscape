...
export const sourceAnalysisJsonSchema = {
  ...
  required: ["templateId", "title", "summary", "sourceExcerpt", "causalQuestion", "primaryCause", "primaryEffect", "misconception", "whyInteractive"],
} as const;
...
export function analysisFromBlueprint(blueprint: LearnscapeBlueprint): SourceAnalysis {
  ...
  return {
    ...
    sourceExcerpt: blueprint.source.relevantExcerpts[0]?.text ?? blueprint.source.summary,
