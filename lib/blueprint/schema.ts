...
export const blueprintSchema = z.object({
  ...
  source: z.object({ sourceType: z.enum(["image", "sample", "manual"]), extractedText: z.string().optional(), summary: z.string(), relevantExcerpts: z.array(z.object({ text: z.string(), conceptIds: z.array(z.string()) })) }),
